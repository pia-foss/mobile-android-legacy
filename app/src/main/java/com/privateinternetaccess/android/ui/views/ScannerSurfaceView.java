...
public class ScannerSurfaceView extends ViewfinderView{
    protected static final String TAG = ScannerSurfaceView.class.getSimpleName();
    ...
    public ScannerSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
