...
public class PiaPrefHandler {
    ...
    public static final String AUTOMATION_IGNORE_DELTA_DUE_TO_USER_ACTION = "AUTOMATION_IGNORE_DELTA_DUE_TO_USER_ACTION";
    ...
    public static void setAutomationIgnoreConnectionDeltaByUserAction(Context context, boolean value) {
        Prefs.with(context).set(AUTOMATION_IGNORE_DELTA_DUE_TO_USER_ACTION, value);
    }

    public static boolean getAutomationIgnoreConnectionDeltaByUserAction(Context context) {
        return Prefs.with(context).getBoolean(AUTOMATION_IGNORE_DELTA_DUE_TO_USER_ACTION);
    }

    public static void resetAutomationIgnoreConnectionDeltaByUserAction(Context context) {
        Prefs.with(context).remove(AUTOMATION_IGNORE_DELTA_DUE_TO_USER_ACTION);
    }
    ...
    public static void resetSettings(Context context) {
        ...
        PiaPrefHandler.resetAutomationIgnoreConnectionDeltaByUserAction(context);
