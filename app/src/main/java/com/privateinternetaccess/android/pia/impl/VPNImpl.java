...
public class VPNImpl implements IVPN {
    ...
    public void start(boolean connectPressed) {
        ...
        // If automation is not disabled and this is a user triggered action.
        if (!PiaPrefHandler.isAutomationDisabledBySettingOrFeatureFlag(context) && connectPressed) {
            PiaPrefHandler.setAutomationIgnoreConnectionDeltaByUserAction(context, true);
        }
    ...
    public void stop(boolean disconnectPressed) {
        ...
        // User triggered action have priority over Automation rules.
        // If automation is not disabled and this is a user triggered action.
        if (!PiaPrefHandler.isAutomationDisabledBySettingOrFeatureFlag(context) && disconnectPressed) {
            PiaPrefHandler.setAutomationIgnoreConnectionDeltaByUserAction(context, true);
        }
